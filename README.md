...
As a practical demonstration, I built a simple Web3 card game -- [Doudizhu Arc Edition](https://github.com/gavin542/doudizhu-arc) -- using the technologies described in these docs, with Arc and Circle serving as the on-chain settlement layer for game stakes.
...
- [doudizhu-arc](https://github.com/gavin542/doudizhu-arc) - Web3 card game on Arc Testnet (USDC betting + on-chain leaderboard)
